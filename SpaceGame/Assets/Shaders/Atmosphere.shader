Shader "Space/Atmosphere"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Rayleigh scatter coefficients per world-unit (1 unit = 637.1 km).
            // Scale as lambda^-4 at (700, 546, 440) nm.
            static const float3 kRayleigh = float3(5.5, 13.0, 22.4);
            // Mie: grey haze, small so Rayleigh blue dominates
            ...
            // LUT: X = normalised altitude [0,1], Y = cosZenith mapped to [0,1]
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                // Sun direction and normalised hue.
                // mainLight.color bakes in Unity light intensity; divide by max channel
                // so _SunIntensity is the sole brightness knob.
